...
XmlHttp.onreadystatechange = function () {  
    ...
    if (XmlHttp.status == 200 && XmlHttp.readyState == 4) {
        ...
        //console.log(message);
        var fieldnames = ["CompanyName", "Address", "City", "Person", "PersonNumber", "URL"];
...
XmlHttp.open("GET", "bpv_show_companies_data.php", true);
...
function updateStatus (evt) {
    ...
    XmlHttp.open("POST", "bpv_show_companies_data_update.php", true);
    XmlHttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
